...
// Source: internal/domain/service/message.go
...
func (m *MockMessageStorage) GetByUsers(ctx context.Context, senderLogin, receiverLogin string) ([]entity.Message, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByUsers", ctx, senderLogin, receiverLogin)
	ret0, _ := ret[0].([]entity.Message)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockMessageStorageMockRecorder) GetByUsers(ctx, senderLogin, receiverLogin interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByUsers", reflect.TypeOf((*MockMessageStorage)(nil).GetByUsers), ctx, senderLogin, receiverLogin)
}
